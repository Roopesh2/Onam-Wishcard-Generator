!(function (t, e) {
	...
	return (function () {
		...
		const s = "alwan",
			...
			rt = (t, e = nt(), s = !1) =>
				tt(t) && t.trim()
					? e["querySelector" + (s ? "All" : "")](t)
					: t instanceof Element && nt().contains(t) && t !== nt()
					? t
					: null,
			ot = (t, e, s = q) => {
			...
			at = (t) => {
				...
				return (
					t === x
						? ((e = s = 0), (n = o = L.clientWidth), (r = i = L.clientHeight))
						: ({
								x: e,
								y: s,
								width: n,
			...
			ct = (t, e = [x]) => (
				t && (t = t.parentElement),
				t && t !== nt()
					? (/auto|scroll|overflow|clip|hidden/.test(
							getComputedStyle(t).overflow,
					  ) && e.push(t),
					  ct(t, e))
					: e
			),
			ut = (t, e, s) =>
				t
					? t.style[et(s) ? "setProperty" : "getPropertyValue"](
							"--alwan-" + e,
							s,
					  )
					: "",
			...
			ft = (t, e, s, n) =>
				lt(C, h + " " + t, e, { type: "range", max: s, step: n }),
			bt = (t, e) => lt("", n, t, {}, e),
			mt = (t, e) => {
				let s = t || dt(b, nt()),
					n = [],
				...
				return {
					...
					i({ preset: e, classname: o }) {
						t &&
							e !== (t !== s) &&
							(s = e ? ht(t, dt(b, null, { id: t.id })) : ht(s, t)),
							R(s, j, r),
							(t && !e) ||
								!tt(o) ||
								(_t(s, n, !1), (n = o.split(/\s+/)), _t(s, n, !0));
					},
					p(t) {
						if (et(t)) {
							const { config: n, u: r } = e,
								o = r.m._;
							(n.disabled = s.disabled = !!t),
								t ? o(e, !1, !0) : st(n) || o(e, !0, !0);
						}
					},
					v() {
				...
				const r = (n, r = e) => {
					...
					o = (t, s) => {
						(!n && st(e.config)) ||
							(s()
								? n
									? (t(), e.config.closeOnScroll && l(e, !1))
									: l(e, !0, !0)
								: l(e, !1, !0));
					},
					i = (s) => {
						if (n) {
							...
							(a !== c &&
								!t.contains(a) &&
								!W(c.labels || []).some((t) => t.contains(a)))
								? l(e, !1)
								: "Tab" === h &&
								  ((n = W(rt("button,input,[tabindex]", t, !0))),
								  (r = n[0]),
								  (o = n.pop()),
								  a !== c || p
										? ((p && a === r) || (!p && a === o)) && (i = c)
										: (i = r),
								  i && (s.preventDefault(), i.focus()));
						}
					},
					l = (s, o, i) => {
						const h = (s = s || e).config;
						(h.disabled && !i) ||
							(et(o) || (n && s !== e && l(e, !1), (o = !n)),
							o !== n &&
								(st(h) || i) &&
								(o && (s !== e && r(h, s), o && a()),
								s === e && ((n = o), _t(t, v, o), e.k.j(o ? H : O, t))));
					},
					a = () => {
						s && s.O();
					};
			...
			Vt =
				'<svg width="18" height="18" viewBox="0 0 24 24" aria-role="none"><path d="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z"></path></svg>',
			zt = (t, e) => {
				let s = "",
					n = t.a,
					r = e;
			...
			It = (t = "", e) => {
				...
				tt(t)
					? (r = t.trim())
					: ((t = t || {}),
					  (n = [F, I].find((e) => e.split("").every((e) => vt(wt(t[e]))))),
					  n && (r = zt(t, n)));
			...
			Dt = (t, e) => {
				...
				return {
						...
						(e = l || e),
							...
							X(o) &&
								...
								o.length &&
									...
									i &&
										((r = dt(w, t, {
											html: '<svg width="20" height="20" viewBox="0 0 24 24" aria-role="none"><path d="M6.984 14.016l5.016-5.016 5.016 5.016h-10.031z"></path></svg>',
										})),
										R(r, j, () => _t(s, $))),
									R(s, j, ({ target: t }) => {
					...
					D(t) {
						(e.config.swatches = n.filter(
							(e, s) => !t.some((t) => t === e || yt(t) === s),
						)),
							this.i(e.config);
					},
				};
		...
		const qt = (t) => {
						...
						const h = lt("", r, t, { tabindex: "0" }),
							...
							c = (t, r) => {
								let o,
									...
									[a, c, u, _] = i;
								t
									? ((a = t.clientX - a), (c = t.clientY - c))
									: ((a = s + (r.x * u) / 100), (c = n + (r.y * _) / 100)),
									(a = Ht(a, u)),
									(c = Ht(c, _)),
									(a === s && c === n) ||
										((s = a),
						...
						const o = (t) => {
								(r = t),
									it(
										n,
										t
											? '<svg width="18" height="18" viewBox="0 0 24 24" aria-role="none"><path d="M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z"></path></svg>'
											: Vt,
									);
							},
							l = (t) => {
					...
					b = ((t, e) => {
						...
						const h = () => e.config.singleInput || "hex" === l[o],
							p = () => {
								...
								(h()
									? [r]
									: (r + (e.config.opacity ? "a" : "")).split("")
								).forEach((e) => {
									const s = lt("label", "", n);
									(i[e] = lt(C, _, s, { type: "text", value: t[e] + "" })),
										lt("span", "", s, { html: e });
								}),
									R(n, C, u),
									R(n, E, u),
							...
							i({ inputs: n, format: i }, a) {
								...
								h || (l = D),
									...
									h &&
										...
										h > 1 &&
											((r = dt("", s, {
												html: '<svg width="15" height="15" viewBox="0 0 20 20" aria-role="none"><path d="M10 1L5 8h10l-5-7zm0 18l5-7H5l5 7z"></path></svg>',
											})),
											R(r, j, c)));
							},
							R(t) {
			...
			Tt = (t, e, s) => (
				(t %= 12),
				At(255 * (s - e * $t(s, 1 - s) * xt(-1, $t(t - 3, 9 - t, 1))))
			),
			Ut = (t) => {
				let e, s;
				const n = {
